...
class ProductControllerTest {
    ...
    void testLists() throws Exception {
        ...
        // Specific Mockito interactions, tell stub to return list of products
        when(productService.listAll()).thenReturn(products);  // need to strip generics to keep Mockito happy
    ...
    void testEdit() throws Exception {
        ...
        mockMvc.perform(get("/product/edit/1"))
                .andExpect(status().isOk())
                .andExpect(view().name("product/maintainproduct"))
                .andExpect(model().attribute("product", instanceOf(Product.class)));
    }
    ...
    void testCreateOrUpdate() throws Exception {
        ...
        when(productService.createOrUpdate(ArgumentMatchers.<Product>any())).thenReturn(returnProduct);
